...
export default function LandingPage({ onStartRegister, onGitHubOAuth, onStartQuickScan }) {
  ...
  return (
    <div className="space-y-16 sm:space-y-24 lg:space-y-28 py-4 sm:py-6 text-white relative overflow-hidden font-sans">
      ...
      {/* Pure White Octocat Sketch Background Watermark */}
      <div className="absolute top-2 sm:top-6 left-1/2 -translate-x-1/2 w-full max-w-3xl h-[480px] pointer-events-none z-0 flex items-center justify-center overflow-hidden opacity-20 sm:opacity-25 select-none">
        <img 
          src="/octocat-white-sketch.png" 
          alt="GitHub Octocat White Sketch Watermark" 
